...
import {IconFolderOpen , IconFolder , IconFile as FileIcon} from '@tabler/icons-react'
...
const Tree = forwardRef<HTMLDivElement, TreeViewProps>(
  (
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: TODO: Need to check
    useEffect(() => {
      ...
      >
        ...
        >
          {expendedItems?.includes(value)
            ? openIcon ?? <IconFolderOpen className="w-4 h-4" />
            : closeIcon ?? <IconFolder className="w-4 h-4" />}
          <span>{element}</span>
        </AccordionPrimitive.Trigger>
